...
import com.online.taxi.constant.Const;
...
import com.online.taxi.map.Dispatch;
import com.online.taxi.map.Vehicle;
import com.online.taxi.map.request.OrderRequest;
import com.online.taxi.mapper.*;
import com.online.taxi.request.DispatchRequest;
import com.online.taxi.request.DistanceRequest;
...
public class DispatchService {
    ...
    public double calDistance(String long1, String lat1, String long2, String lat2){
        ...
        request.setOriginLatitude(lat1);
        request.setOriginLongitude(long1);
        request.setDestinationLatitude(lat2);
        request.setDestinationLongitude(long2);
        return httpService.calDistance(request);
    }
    ...
    public List<TaskCondition> getForceTaskCondition(String cityCode, int serviceTypeId, int round){
        ...
        if(carDispatchDistributeIntervalSet == null)
            return null;
        log.info("#order carDispatchTimeThresholdSet " + JSONObject.fromObject(carDispatchDistributeIntervalSet).toString());
        ...
        for(int i = 0; i < round; i++){
            for(int j = 0; j < 6; j++){
                ...
                list.add(4);
                list.add(6);
                TaskCondition taskCondition = new TaskCondition(carDispatchDistributeIntervalSet.getCarServiceBeforeInterval(), carDispatchDistributeIntervalSet.getCarServiceAfterInterval(), 0, 20, Integer.MAX_VALUE, list, Const.COMPARE_TYPE_1);
    ...
    public List<TaskCondition> getSpecialCondition(String cityCode, int serviceTypeId){
        ...
        TaskCondition taskCondition1 = new TaskCondition(carDispatchDistributeIntervalSet.getCarServiceBeforeInterval(), carDispatchDistributeIntervalSet.getCarServiceAfterInterval(), carDispatchDistributeRadiusSet.getMaxRadius(), 20, carDispatchDistributeRadiusSet.getMaxRadiusFirstPushDriverCount(), null, Const.COMPARE_TYPE_2);
        TaskCondition taskCondition2 = new TaskCondition(carDispatchDistributeIntervalSet.getCarServiceBeforeInterval(), carDispatchDistributeIntervalSet.getCarServiceAfterInterval(), carDispatchDistributeRadiusSet.getMaxRadius(), 20, carDispatchDistributeRadiusSet.getMaxRadiusFirstPushDriverCount(), null, Const.COMPARE_TYPE_2);
    ...
    public List<TaskCondition> getNormalCondition(String cityCode, int serviceTypeId){
        ...
        log.info("#order carDispatchTimeThresholdSet " + JSONObject.fromObject(carDispatchDistributeIntervalSet).toString());
        log.info("#order carDispatchDistributeRadiusSet " + JSONObject.fromObject(carDispatchDistributeRadiusSet).toString());
        TaskCondition taskCondition1 = new TaskCondition(carDispatchDistributeIntervalSet.getCarServiceBeforeInterval(), carDispatchDistributeIntervalSet.getCarServiceAfterInterval(), carDispatchDistributeRadiusSet.getMinRadius(), 20, carDispatchDistributeRadiusSet.getMaxRadiusFirstPushDriverCount(), null, 0);
        TaskCondition taskCondition2 = new TaskCondition(carDispatchDistributeIntervalSet.getCarServiceBeforeInterval(), carDispatchDistributeIntervalSet.getCarServiceAfterInterval(), carDispatchDistributeRadiusSet.getMinRadius(), 20, carDispatchDistributeRadiusSet.getMaxRadiusFirstPushDriverCount(), null, 0);
        TaskCondition taskCondition3 = new TaskCondition(carDispatchDistributeIntervalSet.getCarServiceBeforeInterval(), carDispatchDistributeIntervalSet.getCarServiceAfterInterval(), carDispatchDistributeRadiusSet.getMaxRadius(), 20, carDispatchDistributeRadiusSet.getMaxRadiusFirstPushDriverCount(), null, 0);
        TaskCondition taskCondition4 = new TaskCondition(carDispatchDistributeIntervalSet.getCarServiceBeforeInterval(), carDispatchDistributeIntervalSet.getCarServiceAfterInterval(), carDispatchDistributeRadiusSet.getMaxRadius(), 20, carDispatchDistributeRadiusSet.getMaxRadiusFirstPushDriverCount(), null, 0);
        taskConditions.add(taskCondition1);
        taskConditions.add(taskCondition2);
    ...
    public ResponseResult dispatch(DispatchRequest dispatchRequest){
        ...
        if(null == orderRulePrice){
            return ResponseResult.fail(BusinessInterfaceStatus.FAIL.getCode(), "订单 orderRulePrice为空");
        }
        CarDispatchDistributeIntervalSet carDispatchDistributeIntervalSet = configService.getCarDispatchDistributeIntervalSet(orderRulePrice.getCityCode(), order.getServiceType());
        if(carDispatchDistributeIntervalSet == null){
            return ResponseResult.fail(BusinessInterfaceStatus.FAIL.getCode(),"carDispatchDistributeIntervalSet 为空");
        }
        TaskCondition taskCondition = new TaskCondition(carDispatchDistributeIntervalSet.getCarServiceBeforeInterval(), carDispatchDistributeIntervalSet.getCarServiceAfterInterval(), dispatchRequest.getRadius(), -1, -1, null, -1);
        ...
        for(Vehicle data: response.getData().getVehicles()){
            try {
                ...
                if(searchType){
                    ...
                    if(StringUtils.isNotEmpty(order.getUserFeature().toString())){
                        if(StringUtils.isEmpty(driverInfo.getTags())){
                            continue;
                        }
                        if(!Arrays.asList(driverInfo.getTags().split(",")).containsAll(Arrays.asList(order.getUserFeature().toString().split(",")))){
    ...
    public boolean hasDriver(String city, Date time, int carType, int serviceType){
        CarDispatchDistributeIntervalSet carDispatchDistributeIntervalSet = configService.getCarDispatchDistributeIntervalSet(city, serviceType);
        if(null == carDispatchDistributeIntervalSet){
            return false;
        }
        ...
        if(null == carDispatchCapacitySet){
            return false;
        }
    ...
    private static int getDateTimeType(Date time) {
