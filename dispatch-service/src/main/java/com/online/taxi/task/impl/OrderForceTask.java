...
import com.online.taxi.constant.MessageType;
...
//                                    updateOrder.setOtherMappingId(bindAxbResponse2.getAxbSubsId());
    ...
    public void pushDriver(Order order, OrderRulePrice orderRulePrice, DriverData data, String passengerPhone) {
        try {
            ...
            String typeDesc = "";
            String useFeature = order.getUserFeature().toString();
            String content = "";
            ...
            msg.put("tagList", getTagsJson(order.getUserFeature().toString()));
