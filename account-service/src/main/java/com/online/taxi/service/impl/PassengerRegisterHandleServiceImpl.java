...
public class PassengerRegisterHandleServiceImpl implements PassengerRegisterHandleService {
    ...
    public ResponseResult handle(GetTokenRequest getTokenRequest) {
        ...
        //多终端互踢
        passengerInfoService.queryPassengerInfoByPhoneNum(strPhoneNum);
